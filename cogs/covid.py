...
from assets import time_assets, internet_funs
...
class Covid(commands.Cog, description="Get Covid-19 stats worldwide, or for a specific country"):
    ...
    async def corona_stats(self, ctx, country: str = None):
        ...
        response_dict = await internet_funs.async_get(track_url)
        ...
        updated_date, updated_time = time_assets.parse_utc(str(time_utcformat))
